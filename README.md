...
- Save your edits
- Inside CS110A_resume_project run the following commands in the order. The quoted text in the last command is for bookkeeping your commits.         <img width="298" height="56" alt="2026-01-06 16-21-19" src="https://github.com/user-attachments/assets/82ca92bd-38d9-402e-8097-05e23248e39d" />
           
- Take a screenshot as a part of your midterm project submission. You are still local on your computer. In the step 5 you will push it to your remote GitHub repository.
### 5. Push to GitHub (Terminal) 
- Run the command, <img width="550" height="24" alt="2026-01-06 16-30-10" src="https://github.com/user-attachments/assets/d000e8d3-425b-48c4-8351-914c74ac5ffb" />
- Take a screenshot as a part of your midterm project submission.
### 6. Enable GitHub Pages
- Go to your repository on GitHub.
- Click "Settings" tab on the set of tabs on the top of the page
- In the Settings page, click "Pages" tab on the set of tabs on the panel left side.
- Under Branch, select main and click Save. Wait a minute, then visit: https://YOUR_GitHub_USERNAME.github.io/CS110A_resume_project/esume_1.html Your résumé should be live on the web!

## Submit your resume project
- Invite your professor to your GitHub repository via her/his GitHub user name, or email
- Collect all the screenshots and zip them into a file with your name in the file name
